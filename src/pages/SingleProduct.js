...
const SingleProduct = () => {
  ...
  return (
    <>
      ...
      <Container class1="main-wrapper py-5 home-wrapper-2"> 
          <div className="row">
            <div className="col-6">
              ...
              <div className="main-product-details">
                ...
                <div className="border-bottom py-3">
                  ...
                  <div className="d-flex gap-10 align-items-center my-2">
                    ...
                    <p className="product-data">In Stocke</p>
                  </div>
                  ...
                  <div className="d-flex gap-10 flex-column mt-2 mb-3">
                    ...
                    <div className="d-flex flex-wrap gap-15">
                      ...
                      <span className="badge border border-I bg-white text-dark border-secondary">
                        XXL
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="d-flex gap-10 align-items-center my-3">
                   ...
                   onClick={()=>{
                    copyToClipboard("https://images.pexels.com/photos/277390/pexels-photo-277390.jpeg");
                   }}
                   >
                    Copy Product Link
                   </a>
                ...
                <div className="reviews">
                  <div className="review mt-3">
                    ...
                    <p className="mt-3">
                      ...
                      harum deleniti labore maxime officia esse eos? Repellat?
                    </p>
                  </div>
                </div>
              </div>
